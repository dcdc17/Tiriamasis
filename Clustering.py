...
axs[1, 2].axis('off')
plt.tight_layout()
plt.savefig(os.path.join(BASE, 'cluster', 'clusters_mean.png'))
plt.show()
...
axs[1, 2].axis('off')
plt.tight_layout()
plt.savefig(os.path.join(BASE, 'cluster', 'clusters_dtw.png'))
plt.show()
...
plt.savefig(os.path.join(BASE, 'cluster', 'clusters_dist.png'))
plt.show()
...
r.to_excel(os.path.join(BASE, 'cluster', 'cluster.xlsx'))
